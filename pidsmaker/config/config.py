...
ENCODERS_CFG = {
    ...
    "hypformer": {
        ...
        "trans_use_bn": Arg(bool),
        "trans_use_residual": Arg(bool),
        "trans_use_weight": Arg(bool),
        "trans_use_act": Arg(bool),
        "k_in": Arg(float),
        "k_out": Arg(float),
        "decoder_type": Arg(str, vals=OR(["euc", "hyp"])),
        "add_positional_encoding": Arg(bool),
